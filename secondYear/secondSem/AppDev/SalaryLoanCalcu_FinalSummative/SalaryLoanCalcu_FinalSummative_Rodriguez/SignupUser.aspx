<%@ Page Title="" Language="C#" MasterPageFile="~/defaultMaster.Master" AutoEventWireup="true" CodeFile="SignupUser.aspx.cs" Inherits="SalaryLoanCalcu_FinalSummative_Rodriguez.userSignup" %>
    ...
    <table __designer:mapid="3" class="auto-style16">
        ...
        <tr __designer:mapid="7">
            ...
            <td __designer:mapid="a" class="auto-style35">
                <asp:TextBox ID="txtUserEmail" runat="server" placeholder="Email" Width="265px" Height="29px"></asp:TextBox>
            </td>
        ...
        <tr __designer:mapid="d">
            ...
            <td __designer:mapid="10" class="auto-style33">
                <asp:TextBox ID="txtUserFirstname" runat="server" placeholder="First Name" Width="265px" Height="29px"></asp:TextBox>
            </td>
        ...
        <tr __designer:mapid="d">
            ...
            <td __designer:mapid="e" class="auto-style37">&nbsp;</td>
            <td __designer:mapid="10" class="auto-style33">
                <asp:TextBox ID="txtUserLastname" runat="server" placeholder="Last Name" Width="265px" Height="29px"></asp:TextBox>
            </td>
            <td __designer:mapid="10" class="auto-style27">
        ...
        <tr __designer:mapid="1d">
            ...
            <td __designer:mapid="20" class="auto-style35">
                <asp:TextBox ID="txtMonthlySalary" runat="server" placeholder="Monthly Salary (₱)" Width="265px" Height="29px"></asp:TextBox>
            </td>
        ...
        <tr __designer:mapid="23">
            ...
            <td __designer:mapid="26" class="auto-style35">
                <asp:TextBox ID="txtUserPassword" runat="server" placeholder="password" TextMode="Password" Width="265px" Height="29px"></asp:TextBox>
            </td>
        ...
        <tr __designer:mapid="29">
            ...
            <td __designer:mapid="2c" class="auto-style33">
                <asp:TextBox ID="txtUserConf" runat="server" placeholder="confirm password" TextMode="Password" Width="265px" Height="29px"></asp:TextBox>
                &nbsp;</td>
