<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.Master" AutoEventWireup="true" CodeBehind="adminViewTransaction.aspx.cs" Inherits="WebAppDemo_RodriguezPellosisMagno.adminViewTransaction" %>
    ...
    <table class="w-100" __designer:mapid="a0">
        <tr __designer:mapid="a1">
            <td class="auto-style2" __designer:mapid="a2">
                <h1 __designer:mapid="a3">TRANSACTION RECORDS</h1>
            </td>
