<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RegStudent.aspx.cs" Inherits="WebGradesCalculator_FinalAct1_RodriguezBIT21.Student_Registration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style1">
        <tr>
            ...
            <asp:TextBox ID="txtStudentID" runat="server" Width="171px"></asp:TextBox>
        ...
        &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtStudentID" ErrorMessage="*only numbers" ForeColor="#FF3300" ValidationExpression="^\d+$" ValidationGroup="OnlyNumbers"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtName" ErrorMessage="*only alphabetic letters" ForeColor="#FF3300" ValidationExpression="^[a-zA-Z\s]+$"></asp:RegularExpressionValidator>
        ...
        <tr>
            ...
            <td>
            <asp:Label ID="txtError" runat="server" CssClass="auto-style6" ForeColor="#FF3300" Text="*Student already registered" Visible="False"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="auto-style2">&nbsp;</td>
